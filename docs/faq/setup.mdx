...
```bash copy
# Creating a local environment and activating it
python -m venv .venv
...
```bash copy
# Installing `subgrounds`, the best package!
...
```bash copy
# Freezing dependencies into a file
...
```bash copy
# Installing dependencies into a file
